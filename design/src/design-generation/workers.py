...
#
# Вынесены из xml_viewer.py: там они соседствовали с виджетами, главным окном
...
import errors
import markup_cache
from contour_detector import find_all_contour_names_by_proximity, find_contours, gen_xml
from device_matcher import (extract_lua_names, find_pdf_device_texts, find_sheet_object,
                            load_lua_data, load_pdf_geometry, match_devices)
from extract_geometry import extract_line_segments, extract_text_elements
from parse_lua import lua_table_to_python, merge_lua_data, read_file_with_encoding
from parse_lua_objects import extract_all_data, parse_objects_file
from pdf_processor import (MAX_FAILED_SHARE, DeviceDetector, DeviceLabeler,
...
class PostgresExportThread(QThread):
    ...
    def run(self):
        try:
            from postgreSQL_export import PostgresExporter
