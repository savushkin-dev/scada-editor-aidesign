...
#
# Вынесены из xml_viewer.py, где лежали вперемешку с потоками и главным окном.
...
from objects_loader import Operation as TechOperation, State, Step, objects_data
