...
# никто не рисует. Предела холста у редактора нет — 5000 это
# протяжённость нарисованной сетки, а не мир; нижняя граница зума
# опущена с 0.2 до 0.05, чтобы лист любого формата открывался целиком
